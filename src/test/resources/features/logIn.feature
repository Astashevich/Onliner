...
Feature: Tests for log-in page
  ...
  Scenario: Log-In when fields are empty
    ...
    * The actual field warning text should much expected warning text "укажите ник или e-mail"
  ...
  Scenario: Log-In when password field is empty
    ...
    * Click log-In form button
    Then Chek log-In form on visible
    * The actual field warning text should much expected warning text "укажите пароль"
