...
/**
 * Element factory for wrapped by.onliner.elements. Similar to {@link org.openqa.selenium.support.PageFactory}
 */
public class ElementFactory {
     ...
     *
     * @param searchContext A search context that will be used to look up the by.onliner.elements
