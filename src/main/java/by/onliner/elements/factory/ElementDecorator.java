 ...
 * <p/>
 * It is designed to support and return concrete implementations of wrappers for a variety of common html by.onliner.elements.
 */
public class ElementDecorator implements FieldDecorator {
     ...
     *
     * @param factory for locating by.onliner.elements.
     */
    ...
    /**
     * generates a proxy for a list of by.onliner.elements to be wrapped.
     *
