...
/**
 * Wraps a list of WebElements in multiple wrapped by.onliner.core.elements.
 */
public class ElementListHandler implements InvocationHandler {
    ...
    /**
     * Given an interface and a locator, apply a wrapper over a list of by.onliner.core.elements.
     *
     * @param interfaceType interface type we're trying to wrap around the element.
     * @param locator       locator on the by.onliner.page for the by.onliner.core.elements.
