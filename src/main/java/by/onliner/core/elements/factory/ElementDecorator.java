 ...
 * <p/>
 * It is designed to support and return concrete implementations of wrappers for a variety of common html by.onliner.core.elements.
 */
public class ElementDecorator implements FieldDecorator {
     ...
     *
     * @param factory for locating by.onliner.core.elements.
     */
     ...
     * @param locator       ElementLocator pointing at a proxy of the object on the by.onliner.page
    ...
    /**
     * generates a proxy for a list of by.onliner.core.elements to be wrapped.
     *
     ...
     * @param locator       locator for items on the by.onliner.page being wrapped
